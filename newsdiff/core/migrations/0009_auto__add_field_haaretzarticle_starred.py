...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HaaretzArticle.starred'
        db.add_column(u'core_haaretzarticle', 'starred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HaaretzArticle.starred'
        db.delete_column(u'core_haaretzarticle', 'starred')
