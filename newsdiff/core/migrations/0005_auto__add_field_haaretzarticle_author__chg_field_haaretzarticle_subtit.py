...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HaaretzArticle.author'
        db.add_column(u'core_haaretzarticle', 'author',
                      self.gf('django.db.models.fields.CharField')(default='(unknown)', max_length=30),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'HaaretzArticle.author'
        db.delete_column(u'core_haaretzarticle', 'author')


        # Changing field 'HaaretzArticle.subtitle'
        db.alter_column(u'core_haaretzarticle', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
    ...
    models = {
        ...
        u'core.haaretzimage': {
            ...
            'origin_url': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
        },
        u'core.newsdiffuser': {
