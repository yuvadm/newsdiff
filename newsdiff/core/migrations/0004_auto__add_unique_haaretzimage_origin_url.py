...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'HaaretzImage', fields ['origin_url']
        db.create_unique(u'core_haaretzimage', ['origin_url'])


    def backwards(self, orm):
        # Removing unique constraint on 'HaaretzImage', fields ['origin_url']
        db.delete_unique(u'core_haaretzimage', ['origin_url'])
